...
\begin{itemize}
	...
	\item \textbf{Stopping on Request:} If a referee, member of the \abb{TC}, \abb{OC}, or \abb{EC}, or trustee of the federation tells the team to stop the robot, there will be no discussion and the robot must be stopped \emph{immediately}.
\end{itemize}
